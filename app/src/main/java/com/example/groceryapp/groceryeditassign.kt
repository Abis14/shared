...
class groceryeditassign :BottomSheetDialogFragment(),assingedadapter.Adaptercallbacks{
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_groceryaddassign, container, false)
    ...
    override fun onclick(text: String, uid: String) {
        ...
        val addtolist =editfragment()
        fragmentTransaction?.replace(R.id.unique, addtolist)
        val bundle = Bundle()
