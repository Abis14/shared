 ...
 */
class groceryeditcategory :BottomSheetDialogFragment(),categoryadapter.Adaptercallback {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_groceryaddcategory, container, false)
